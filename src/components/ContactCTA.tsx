          ...
          <div className="fade-right px-4">
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center items-stretch gap-4">
              <a href="#contact-form" className="w-full">
                <Button className="w-full h-full bg-agri-green hover:bg-agri-green/90 text-white font-medium text-base py-6 rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                  無料相談する
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </a>
              <a href="tel:03-1234-5678" className="w-full">
                <Button variant="outline" className="w-full h-full border-agri-green text-agri-green hover:bg-agri-green/10 font-medium text-base py-6 rounded-lg transition-all duration-300">
